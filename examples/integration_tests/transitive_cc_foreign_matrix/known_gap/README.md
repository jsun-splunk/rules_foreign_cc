...
`:provider_libarchive_shared_zlib_static`
...
`:provider_libarchive_shared_zlib_foreign_static`
...
The default `cmake_static_deps` matrix avoids the first gap by declaring both
